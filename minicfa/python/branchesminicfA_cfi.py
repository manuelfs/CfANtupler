...
configurableAnalysis = cms.EDFilter("minicfa",
    Selections = cms.PSet(
        filters = cms.PSet(),
        selections = cms.PSet(
...
#                        'cm_ExpectedHitsOuter:combinedMuon.trackerExpectedHitsOuter.numberOfHits',
                       ...
                       'picky_LayersWithoutMeasurement:pickyMuon.hitPattern.trackerLayersWithoutMeasurement(\'TRACK_HITS\')',
...
#                        'picky_ExpectedHitsOuter:pickyMuon.trackerExpectedHitsOuter.numberOfHits',
                       ...
                       'tpfms_LayersWithoutMeasurement:tpfmsMuon.hitPattern.trackerLayersWithoutMeasurement(\'TRACK_HITS\')',
            ...
            jets_AK4 = cms.PSet(
                ...
                leaves = cms.PSet(
                    ...
                    vars = cms.vstring(
                        ...
                        'btag_secVertexCombined:bDiscriminator("combinedInclusiveSecondaryVertexV2BJetTags")',
                        'jetCharge:jetCharge',
